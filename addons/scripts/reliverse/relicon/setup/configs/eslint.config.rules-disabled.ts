...
export default tseslint.config(
  ...
  },
  {
    ...
    rules: {
      ...
      "@stylistic/block-spacing": ["off", "always"],
      ...
      "@stylistic/comma-style": ["off", "last"],
      "@stylistic/computed-property-spacing": ["off", "always"],
      "@stylistic/dot-location": ["off", "property"],
      ...
      "@stylistic/jsx-indent-props": ["off", 2],
      ...
      "@stylistic/new-parens": ["off", "always"],
      ...
      "@stylistic/quote-props": ["off", "as-needed"],
      "@stylistic/quotes": [
        "off",
        "double",
        {
      ...
      "@stylistic/template-tag-spacing": ["off", "never"],
      ...
      "@stylistic/wrap-iife": ["off", "outside"],
      ...
      "no-console": [
        "off",
        {
          allow: ["log", "off", "off", "info", "trace", "clear"],
        },
      ],
      "no-const-assign": "off",
