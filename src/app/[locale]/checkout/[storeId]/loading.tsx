  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`
            container flex max-w-xl flex-col items-center space-y-1.5
        ...
        <ScrollArea className="h-full">
          <div
            className={`
              container hidden w-full max-w-xl flex-col gap-5
              ...
              <div key={index} className="space-y-3">
                ...
                >
                  <div className="flex items-center space-x-4">
                    ...
                    <div
                      className={`
                        flex flex-1 flex-col space-y-2 self-start text-sm
                      `}
                    >
      ...
      <div
        className={`
          size-full flex-1 bg-white pb-12 pt-10
          ...
          >
            {Array.from({
              ...
              <fieldset key={index} className="space-y-2">
                ...
                <div
                  className={`
                    flex h-11 items-center rounded border border-muted/10
